...
def generate_percentage_chart(weekly_data: Dict[str, Any]) -> str:
    ...
    legend_explanation = [
        ...
        "- ⚙️ **Dependabot Automation Rate**: Percentage of total PRs that were automatically generated by Dependabot"
    ]
...
def main():
    ...
    try:
        ...
        write_to_step_summary("*This chart displays the adoption rates as percentages of total PRs over time.*")
